...
=== 수정 제안서 수정
.curl-request
include::{snippets}/patch-post-suggested-edits/curl-request.adoc[]

.http-request
include::{snippets}/patch-post-suggested-edits/http-request.adoc[]

.path-parameters
include::{snippets}/patch-post-suggested-edits/path-parameters.adoc[]

.request-fields
include::{snippets}/patch-post-suggested-edits/request-fields.adoc[]

.http-response
include::{snippets}/patch-post-suggested-edits/http-response.adoc[]

.response-fields
include::{snippets}/patch-post-suggested-edits/response-fields.adoc[]
